        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheckConstraint", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("PhoneCheckConstraint", "Phone LIKE '011%' or Phone LIKE '012%' or Phone LIKE '015%' or Phone LIKE '010%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PlanCheckConstraint", "DurationDays BETWEEN 1 AND 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheckConstraint1", "Email LIKE '_%@_%._%'");
                    table.CheckConstraint("PhoneCheckConstraint1", "Phone LIKE '011%' or Phone LIKE '012%' or Phone LIKE '015%' or Phone LIKE '010%'");
                });
